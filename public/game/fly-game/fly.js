...
const settings = {
  ...
  sensitivity: 5,   // 1..10
  invertY: false,
  // These sit on preset stops on purpose: the six buttons under each
  // slider are at fifths of the range, and a default between two of them
  // leaves the row with nothing lit and looking broken.
  volume: 6,        // 0..10
